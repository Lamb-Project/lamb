---
topic: ui-knowledge-bases
covers: [tutorial, screenshots, file-picker, upload, ingestion, status, query]
answers:
...
![Create Knowledge Base dialog with a name and description](/img/aac-tutorials/kb-create.png)

[Open full-size screenshot](/img/aac-tutorials/kb-create.png)
...
![Ingest Content tab with the file chooser highlighted](/img/aac-tutorials/kb-select-file.png)

[Open full-size screenshot](/img/aac-tutorials/kb-select-file.png)
...
![Selected course-notes.md and the Upload File button highlighted](/img/aac-tutorials/kb-ingest.png)

[Open full-size screenshot](/img/aac-tutorials/kb-ingest.png)
...
![Files tab with processing status and Refresh Status control](/img/aac-tutorials/kb-files.png)

[Open full-size screenshot](/img/aac-tutorials/kb-files.png)
...
![Query results containing the actual sample source fact CORAL-19](/img/aac-tutorials/kb-query.png)

[Open full-size screenshot](/img/aac-tutorials/kb-query.png)
