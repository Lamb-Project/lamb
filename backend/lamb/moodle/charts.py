    ...
    def read(self, identity):
        try:
            ...
            if (not isinstance(envelope, dict)
                    ...
                    or envelope['snapshot'].get('recipe') != 'assignment-submissions-v1'
                    or envelope.get('command', 'moodle.chart.submissions') != 'moodle.chart.submissions'):
                raise ValueError('Unsupported saved chart')
