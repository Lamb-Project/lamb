...
def _extract_user_id(request: Dict[str, Any]) -> str:
    ...
    user_id = (
        ...
        or metadata.get("lti_user_id")
        or metadata.get("lis_person_sourcedid")
...
def prompt_processor(
    ...
    moodle_user = _extract_user_id(request) if uses_moodle_user else ""
