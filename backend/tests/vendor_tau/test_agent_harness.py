...
from lamb._vendor.tau.tau_agent import (
    AgentTool,
    AgentToolResult,
    AssistantMessage,
    MessageEndEvent,
...
from lamb._vendor.tau.tau_agent.harness import AgentHarness, AgentHarnessConfig
from lamb._vendor.tau.tau_agent.types import JSONValue
from lamb._vendor.tau.tau_ai import (
    FakeProvider,
