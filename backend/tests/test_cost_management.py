...
def fresh_db(tmp_path, monkeypatch):
    ...
    for flag in ('_migrations_applied', '_optimizations_applied', '_system_org_initialized'):
        monkeypatch.setattr(LambDatabaseManager, flag, False)
