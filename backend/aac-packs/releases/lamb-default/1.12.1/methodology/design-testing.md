...
answer, and a raw KB query is a separate probe. Saved scenarios make comparisons
...
If a change is proposed, keep the scenario fixed, rerun and compare evidence. Include
