...
Assessment comparison: require 2–20 explicit gradebook item IDs, not assignment/quiz IDs; ask if unknown. Uses stored final grades with overrides, not raw marks. Stale/unsupported items have no score comparison. Pass denominator: valid nonexcluded grades. Missing-grade denominator: nonexcluded target population, not submissions. Targeting ignores date gates; populations may differ. Median/IQR differences prove neither difficulty nor learning/causality. Saved reads do not refresh.
