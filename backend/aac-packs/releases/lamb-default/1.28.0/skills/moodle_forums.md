...
Select the verified instructor course, then read the forum and complete thread before drafting. Listings return discussion_id for posts reads and first_post_id for replies to the opening post. Never interchange them or guess another ID after a denial.
