...
from lamb_cli.commands import result, learning_scenario, aac, analytics, assistant, job, kb, library, model, moodle, org, rubric, template, test, user
...
app.add_typer(moodle.app, name="moodle")
app.add_typer(learning_scenario.app, name="learning-scenario")
