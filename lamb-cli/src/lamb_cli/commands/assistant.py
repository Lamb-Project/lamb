...
def create_assistant(
    ...
    file_path: Optional[str] = typer.Option(None, "--file-reference", "--file-path", help="Existing owned uploaded-file reference for single-file RAG, never a local filesystem path."),
