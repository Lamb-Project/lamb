...
const messages = {
    en: {
        ...
        historyUnknown: 'Collection complete; historical completeness unknown',
        collectionIncomplete: 'Collection incomplete; historical completeness unknown',
        empty: 'No assignments were found in this course.', unavailable: 'No supported assignment counts are available.',
        analyticsEmpty: 'No records were found for this analysis.', analyticsUnavailable: 'No supported counts are available for this analysis.',
    ...
    es: {
        ...
        historyUnknown: 'Consulta completa; integridad histórica desconocida',
        collectionIncomplete: 'Consulta incompleta; integridad histórica desconocida',
        empty: 'No se han encontrado tareas en este curso.', unavailable: 'No hay recuentos de tareas compatibles disponibles.',
        analyticsEmpty: 'No se han encontrado registros para este análisis.', analyticsUnavailable: 'No hay recuentos compatibles disponibles para este análisis.',
    ...
    ca: {
        ...
        historyUnknown: 'Consulta completa; integritat històrica desconeguda',
        collectionIncomplete: 'Consulta incompleta; integritat històrica desconeguda',
        empty: 'No s’han trobat tasques en aquest curs.', unavailable: 'No hi ha recomptes de tasques compatibles disponibles.',
        analyticsEmpty: 'No s’han trobat registres per a aquesta anàlisi.', analyticsUnavailable: 'No hi ha recomptes compatibles disponibles per a aquesta anàlisi.',
    ...
    eu: {
        ...
        historyUnknown: 'Bilketa osoa; historiaren osotasuna ezezaguna',
        collectionIncomplete: 'Bilketa osatugabea; historiaren osotasuna ezezaguna',
        empty: 'Ez da zereginik aurkitu ikastaro honetan.', unavailable: 'Ez dago zeregin bateragarrien kopururik erabilgarri.',
        analyticsEmpty: 'Ez da erregistrorik aurkitu analisi honetarako.', analyticsUnavailable: 'Ez dago kopuru bateragarririk erabilgarri analisi honetarako.',
