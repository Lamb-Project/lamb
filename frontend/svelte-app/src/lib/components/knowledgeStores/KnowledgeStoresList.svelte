...
<div class="bg-white shadow rounded-lg overflow-hidden">
    <div class="px-4 py-4 sm:px-6 flex items-center justify-between border-b border-gray-200">
        <div class="flex gap-4">
            <button
                type="button"
                class="text-sm font-medium pb-1 border-b-2 {currentTab === 'my'
            ...
            <button
                type="button"
                class="text-sm font-medium pb-1 border-b-2 {currentTab === 'shared'
                    ? 'border-[#2271b3] text-[#2271b3]'
                    : 'border-transparent text-gray-500 hover:text-gray-700'}"
    ...
    {#if successMessage}
        <div
            class="px-4 py-3 bg-green-50 border-b border-green-100 text-sm text-green-700"
            role="status"
        >
            {successMessage}
        </div>
