...
<div class="lang-selector relative">
	<button
		onclick={() => (open = !open)}
		class="inline-flex items-center rounded-md border border-gray-300 bg-white font-medium text-gray-700 hover:bg-gray-50 {size ===
		'small'
	...
	>
		...
		<svg
			class={size === 'small' ? 'ml-0.5 h-3 w-3' : 'ml-1 h-4 w-4'}
