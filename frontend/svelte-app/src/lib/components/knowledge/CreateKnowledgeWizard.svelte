...
<div
    ...
    >
        ...
        <div
            class="bg-white rounded-lg shadow-xl max-w-3xl w-full mx-4 max-h-[92vh] flex flex-col"
        ...
        >
            <header class="px-6 py-4 border-b border-gray-200">
                ...
                <div
                    class="mt-2 flex items-center gap-3 text-sm text-gray-600"
                    aria-live="polite"
                >
                ...
                <div class="mt-2 h-1 w-full bg-gray-100 rounded-full overflow-hidden" aria-hidden="true">
                    <div
            ...
            <footer class="px-6 py-4 border-t border-gray-200 flex items-center justify-between gap-2">
                <button
                    type="button"
                    onclick={goBack}
