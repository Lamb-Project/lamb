...
<div class="space-y-4">
    ...
    <p class="text-sm text-gray-600">
        {$_('knowledge.wizard.step2.description', {
            default: 'Sensible defaults are pre-selected. Click "Edit defaults" to customize, or just continue.'
        })}
    </p>
    ...
    {:else}
        <div class="rounded-md border border-gray-200 bg-gray-50 p-3 text-sm text-gray-700">
            <div>
                <span class="font-medium">{$_('knowledge.wizard.step2.defaultPlugin', { default: 'Default import plugin' })}:</span>
