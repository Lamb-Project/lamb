			...
			>
				...
				<form onsubmit={handleSubmit} class="space-y-4">
					...
					<div>
							...
							<div class="mt-2 rounded-md border border-blue-200 bg-blue-50 p-2">
								<p class="text-sm text-blue-800">
									<span class="font-semibold"
										>{$_('knowledgeBases.createModal.willBeSaved', {
						...
						{:else if !name.trim()}
							<p class="mt-1 text-xs text-gray-500">
								{$_('knowledgeBases.createModal.nameHint', {
					...
					<div class="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
						<button
							type="submit"
							class="bg-brand hover:bg-brand-hover focus:ring-brand inline-flex w-full justify-center rounded-md border border-transparent px-4 py-2 text-base font-medium text-white shadow-sm focus:ring-2 focus:ring-offset-2 focus:outline-none sm:col-start-2 sm:text-sm"
